...
<body class="min-h-screen flex flex-col bg-gray-50 text-slate-800">
  <div class="bg-blue-600 text-white px-6 py-4 flex items-center justify-between">
    <div class="flex items-center gap-3"><i data-lucide="edit-3" class="h-6 w-6"></i><h1 class="text-lg font-semibold">Edit Ticket</h1></div>
    <a id="backLink" href="./view-tickets.php" class="text-sm underline">Back to Tickets</a>
  </div>
  ...
  <script type="module">
    import { tickets, heis } from '../assets/mock/mock-data.js';
