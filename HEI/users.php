...
<body class="min-h-screen flex flex-col bg-gray-50 text-slate-800">
  <div class="bg-emerald-600 text-white px-6 py-4 flex items-center justify-between">
    <div class="flex items-center gap-3"><i data-lucide="users" class="h-6 w-6"></i><h1 class="text-lg font-semibold">HEI Users</h1></div>
  ...
  <div class="flex-1 flex">
    <aside class="w-64 bg-white border-r border-slate-200">
      <nav class="p-4 space-y-1">
        ...
        <a class="block px-3 py-2 rounded hover:bg-slate-50" href="./institution-profile.php">Profile</a>
        <a class="block px-3 py-2 rounded bg-slate-100" href="./users.php">Users</a>
      </nav>
    </aside>
