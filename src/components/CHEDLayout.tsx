...
const menuItems = [
  ...
  { id: 'view-heis', label: 'Institutions', icon: Building2 },
  { id: 'view-tickets', label: 'Tickets', icon: Ticket },
  { id: 'data-enrollment', label: 'Enrollment Data', icon: FileText },
...
export function CHEDLayout({ children, currentPage, onNavigate }: CHEDLayoutProps) {
        ...
        <div className="flex items-center justify-between px-4 sm:px-6 lg:px-8 py-3">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-lg" style={{ color: 'var(--ph-blue)' }}>CHED Portal</h1>
                <p className="text-xs text-gray-500">Commission on Higher Education</p>
              </div>
            </div>
          </div>
              ...
              <DropdownMenuContent align="end" className="w-80">
                ...
                <div className="space-y-2 p-2">
                  <div className="p-2 hover:bg-gray-50 rounded-md cursor-pointer">
                    <p className="text-sm">New comment on Enrollment ticket</p>
                    <p className="text-xs text-gray-500">5 minutes ago</p>
                  </div>
                  <div className="p-2 hover:bg-gray-50 rounded-md cursor-pointer">
                    <p className="text-sm">ETL job completed successfully</p>
              ...
              <DropdownMenuTrigger asChild>
                <Button variant="ghost" className="gap-2">
                  ...
                  <div className="text-left hidden md:block">
                    ...
                    <p className="text-xs text-gray-500">CHED Admin</p>
                  </div>
                </Button>
              </DropdownMenuTrigger>
